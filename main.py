...
def permute_rates(step_size_mutation=0.1, step_size_elite=0.1):
    ...
    elite = 0.4
    for mut_r in mutations:
        # smaller parameters to decrease run time
        run(n_players=50, n_games=30, n_matchups=30, elite=elite, mutation_rate=round(mut_r, 2),
...
if __name__ == '__main__':
    ...
    # run(n_games=50, n_matchups=70, n_generations=100, n_players=100, elite=0.5,
    #       memory_capacity=3, mutation_rate=0.5, verbose=False)
